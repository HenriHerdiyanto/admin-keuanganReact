...
function FormKegiatanBlud({
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const url = editId
        ? `http://20.2.2.230/simkeu/public/api/data_kegiatan_blud/${editId}`
        : "http://20.2.2.230/simkeu/public/api/data_kegiatan_blud";
...
export default FormKegiatanBlud;
