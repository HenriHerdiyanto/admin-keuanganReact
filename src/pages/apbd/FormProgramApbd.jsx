...
function FormProgramApbd({
  ...
  // Effect untuk mendeteksi apakah ini mode Edit atau Tambah Baru
  useEffect(() => {
    if (editData) {
      setForm({
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const url = editId
        ? `http://20.2.2.230/simkeu/public/api/data_apbd/${editId}`
      ...
      // Panggil callback ke parent untuk update UI dataProgram
...
export default FormProgramApbd;
